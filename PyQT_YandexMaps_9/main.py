...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 80, 421, 71))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(430, 80, 351, 71))
...
" через запятую:"))
        ...
        self.label_6.setText(_translate("MainWindow", " Полный адрес:"))
        self.pushButton_2.clicked.connect(self.show_png_address)
        self.pushButton_3.clicked.connect(self.clear)
        self.checkBox.stateChanged.connect(self.box_click)
        self.start_m = 0
        self.index_box = 0
        
    def box_click(self, state):
        if state == Qt.Checked:
            self.index_box = 1
        else:
            self.index_box = 0
    def clear(self):
        map_request = f"https://static-maps.yandex.ru/1.x/?ll=0,0&spn=0.002,0.002&l=map"
    ...
    def create_map(self, first, second, m, vid):              # create_map function
        ...
        map_request = f"http://static-maps.yandex.ru/1.x/?pt={coords},pm2rdm&ll={coords}&spn={m}&l={vid}"
        response = requests.get(map_request)
    ...
    def show_png_address(self):                       # вывод карты по адресу
        ...
        # Полный адрес топонима:
            ...
            if self.index_box == 1:
                self.lineEdit_4.setText(f"Индекс: {toponym_index}, {toponym_address}")
            else:
                self.lineEdit_4.setText(f"{toponym_address}")
        # Координаты центра топонима:
            toponym_coodrinates = toponym["Point"]["pos"]
        # Печатаем извлечённые из ответа поля:
            print(toponym_address, "имеет координаты:", toponym_coodrinates)
            cor = ','.join(toponym_coodrinates.split())
            self.lineEdit.setText(f"{cor.split(',')[1]},{cor.split(',')[0]}")
